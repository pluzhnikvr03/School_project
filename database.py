...
def add_books_to_database():
    ...
    books = [
        ("TEST-001", "Алгебра 7 класс", "Макарычев", "2020"),  # Книга 1: Алгебра
        ("TEST-002", "История 10 класс", "Мединский", "2023"),   # Книга 2: Физика
        ("TEST-003", "Английский язык 10 класс", "Афанасьева", "2018"),  # Книга 3: Русский язык
        ("TEST-004", "История 8 класс", "Юдовская", "2019"),  # Книга 4: История
        ("TEST-005", "Геометрия 10 класс", "Мерзляк", "2024"),  # Книга 5: География
    ]
